...
- The Device List shows a status indicator for each Bitaxe Device, Green - Bitaxe Dashboard can reach the devices API, Red - The device is likely down or offline.
Recommended:
